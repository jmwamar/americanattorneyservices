            ...
            <div class="row ">
                <div class="col-lg-12 col-sm-12">
                    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                        <h3 class="section-title bg-white text-center text-blue px-3">PHILOSOPHY</h3> 
                        <div>
                        </div>
                    </div> 
                </div> 
                            ...
                            <div class="course-item "> 
                                <div class="text-center p-4 border-blue">
                                    ...
                                    <div class="mt-1" style="font-size: 16px;text-align: left;">
                                        As the owner of American Attorney Services, a company specializing in civil process service, it will always be my assurance to deliver a product in a dependable, professional, and timely manner. This is the only way I know how to conduct business. In my fifteen years as a legal support manager and owner I have overseen thousands of jobs and made sure they were completed to legal standards.<br/><br/>

                                        To be successful in this highly competitive industry a client should receive what we call “personalized service.” This type of service originates with the initial phone call and order request. “Listening to our clients, completing each job to their expectation and keeping a constant line of communication is what we do best.”<br/><br/>


                                        American Attorney Services does not take its clients for granted. We are a company that truly cares about each one of our clients, no matter how big or small. We understand the importance of customer service and customer relations, therefore we work very hard to ensure our clients are getting the level of personalized service that is expected in this industry, but hardly ever achieved. You can count on us to be very dependable, professional and to always provide service with a “smile.” Give us a chance to prove ourselves.
                                    </div>
                                </div> 
                            </div>
                        </div>
